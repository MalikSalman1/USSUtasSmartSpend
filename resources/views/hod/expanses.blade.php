    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{route('hod.expanse.reject')}}" method="POST">
            ...
            <tbody>
                ...
                <input type="hidden" value="{{$expanse->id}}">
                    ...
                    <td>
                        ...
                        <a href="{{route('hod.expanse.accept', $expanse->id)}}" class="btn btn-success btn-sm">Accept</a>
                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">Reject</button>
                        <!-- download -->
                        <a href="{{route('hod.expanse.download', $expanse->file)}}" class="btn btn-success btn-sm">Download</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
